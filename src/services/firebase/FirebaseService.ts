...
export class FirebaseService {
     ...
     * ATUALIZADO: Agora usa o ID fornecido ao invés de gerar um novo
     */
    static async createVault(vaultData: any): Promise<string> {
        try {
            ...
            console.log('Firebase: Caixa criado com ID:', vaultId);
            return vaultId;
        } catch (error) {
    ...
    /**
   * Buscar um caixa específico por ID
   */
    static async getVaultById(vaultId: string): Promise<any | null> {
        try {
            console.log('Firebase: Buscando caixa por ID:', vaultId);
            ...
            if (!doc.exists) {
                console.log('Firebase: Caixa não encontrado');
                return null;
            }
            ...
            console.log('Firebase: Caixa encontrado:', vaultData?.name || 'sem nome');
            return vault;
        } catch (error) {
            console.error('Firebase: Erro ao buscar caixa:', error);
            return null;
        }
    }
